...
func TestTools_UploadOneFile(t *testing.T) {
	...
	uploadedOneFile, err := testTools.UploadOneFile(request, "./testdata/uploads/", true)
	if err != nil {
		t.Error(err)
	}

	if _, err := os.Stat(fmt.Sprintf("./testdata/uploads/%s", uploadedOneFile.NewFileName)); os.IsNotExist(err) {
		t.Errorf("expected file to exists: %s", err.Error())
	}

	// clean up
	_ = os.Remove(fmt.Sprintf("./testdata/uploads/%s", uploadedOneFile.NewFileName))
...
func TestTools_DownloadStaticFile(t *testing.T) {
	...
	var testTool Tools
	testTool.DownloadStaticFiles(rr, req, "./testdata", "pic.jpg", "puppy.jpg")
